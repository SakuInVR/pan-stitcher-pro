...
function setupEditor(){const total=Math.max(1,editorState.spatial.length-1),select=$('#seamSelect');select.max=total-1;select.value=0;$('#seamEditor').hidden=editorState.spatial.length<2;updateSeamUI(false)}
